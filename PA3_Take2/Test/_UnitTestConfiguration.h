...
#define Mat4_TimesEqual_Quat     false

#define Quat_TimesEqual_Rot      false
#define Quat_TimesEqual_Quat     true

#define	Rot_TimesEqual_Rot       true
#define	Rot_TimesEqual_Quat      false
...
#define Yahtzee                  false


#define QuatApp_SlerpDataArray                  false
#define QuatApp_SlerpDataArray0                 false
#define QuatApp_SlerpDataArray1                 false
#define QuatApp_SlerpData                       false
...
#define Rot_Mult_Quat                           false  
#define Rot_MultEqual_Quat                      false 
...
#define Quat_RotTimesQuat                       false
#define Quat_QuatTimesEqualRot                  false

#define Quat_QuatDivQuat                         false
#define Quat_QuatDivEqualQuat                    false
#define Quat_QuatDivConst                        false
#define Quat_QuatDivEqualConst                   false
#define Quat_ConstDivQuat                        false
#define Quat_EqualOperator                       true
#define Quat_vectTimesQuat                       false
#define Quat_vectTimesEqualQuat                  false
#define Quat_vectTimesQuat2                      false
#define Quat_vectTimesEqualQuat2                 false
...
#define Quat_ROT_ORIENT_Constructor              false
#define Quat_ROT_INVERSE_ORIENT_Constructor      false
...
#define Quat_Lqcvq_Lqvqc_1                       false
#define Quat_Dot                                 true
#define Quat_Assignment_Rot                      false
#define Quat_Proxy                               false
...
#define Quat_ROT_ORIENT_set                     false
#define Quat_ROT_INVERSE_ORIENT_set             false
